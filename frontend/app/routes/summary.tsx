    ...
    <main className="pt-6 px-6 container mx-auto">
      <section className="py-6" id="summary">
        ...
        <p className="pl-4 text-lg max-w-7xl">
          As mentioned on the Dashboard, Artificial Intelligence (AI) has seen some rapid
          growth in recent years, with a lot of growth in just the last year alone.
        </p>
        <ARChart />
        <p className="pl-4 text-lg max-w-7xl mb-2">
          The chart above showcases some of the biggest AI releases in the last few months.
          Each of these major corporations have released innovative AI models with huge
          advancements since previous versions. By clicking on each dot in the graph, you
          can see more details about each release, including the model name, release date,
          and some of the key innovations introduced with that model. Each dot is color coded
          to a developer, and the legend is found just above the chart. 
          <br />
          <br />
          As is clearly visible, models have only been getting more advanced with each release, 
          and each company is leveraging new innovations each time, instead of just minor tweaks. 
          Not only that, but this is just some of the major releases; these are just the major
